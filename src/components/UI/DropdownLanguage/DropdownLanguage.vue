<template>
  <div ref="parentRef" @click="toggle" :class="[
    $style.default,
    $style.langDtopdown,
    ...
    <div :class="$style.list">
      <NuxtLink
        v-for="locale in (($i18n as any).locales as LocaleObject[])"
...
<script setup lang="ts">
  ...
  const glob = import.meta.glob(
    '~/assets/svg/locales/*.svg', { eager: true }
...
<style lang="scss" src="./DropdownLanguage.module.scss" module></style>
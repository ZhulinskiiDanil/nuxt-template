  ...
  <div :class="$style.container">
    ...
    <div :class="$style.row">
      ...
      <UIInputWrapper
        title="Пароль"
        :error="
          v$.password.$errors[0]?.$message.toString() || null
        "
      >
        <UIInput
          v-model="v$.password.$model"
      ...
      <p :class="$style.description">
        <i>
          ...
          в
          <b>UIInputWrapper</b>
          чтобы дополнить его ошибками, заголовками итп
        </i>
      </p>
    </div>
    ...
    <div :class="$style.row">
      ...
      <span>
        <i>
          <b>Phone Number:</b>
          {{ v$.testMask.$model || 'Empty' }}
        </i>
      </span>
      <div
        v-for="error of v$.testMask.$errors"
        :key="error.$uid"
      >
        {{ error.$message }}
      </div>
    ...
    <div :class="$style.row">
      <UIModal :visible="data.modal" @hide="data.modal = false">
        <div style="padding: 2rem">
          ...
          <h4>{{ $t('helloWorld') }} {{ $t('helloWorld') }}</h4>
          <br />
          <br />
      ...
      <p :class="$style.description">
        <i>
          Кастомные модальные окна создаются в
          /components/Modal/*
        </i>
      </p>
    </div>
    ...
    <div :class="$style.row">
      ...
      <UISwitcher v-model="v$.switcher.$model" />
      <div
        v-for="error of v$.switcher.$errors"
        :key="error.$uid"
      >
        {{ error.$message }}
      </div>
